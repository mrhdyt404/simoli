...
@section('page-title', 'Edit Data Pengaliran')
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $pengaliran->tanggal?->format('Y-m-d')) }}" required>
                            @error('tanggal') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Jam Mulai <span class="text-danger">*</span></label>
                            <input type="time" name="jam_mulai" class="form-control @error('jam_mulai') is-invalid @enderror" value="{{ old('jam_mulai', $pengaliran->jam_mulai) }}" required>
                            @error('jam_mulai') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Jam Selesai <span class="text-danger">*</span></label>
                            <input type="time" name="jam_selesai" class="form-control @error('jam_selesai') is-invalid @enderror" value="{{ old('jam_selesai', $pengaliran->jam_selesai) }}" required>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="no_bak" class="form-control @error('no_bak') is-invalid @enderror" value="{{ old('no_bak', $pengaliran->no_bak) }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="blok" class="form-control @error('blok') is-invalid @enderror" value="{{ old('blok', $pengaliran->blok) }}" required>
                            @error('blok') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Rotasi</label>
                            <input type="text" name="rotasi" class="form-control @error('rotasi') is-invalid @enderror" value="{{ old('rotasi', $pengaliran->rotasi) }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" name="flat_bed" class="form-control @error('flat_bed') is-invalid @enderror" value="{{ old('flat_bed', $pengaliran->flat_bed) }}" min="0" required>
                            @error('flat_bed') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Vol. Dihasilkan <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="number" name="vol_limbah_dihasilkan" class="form-control @error('vol_limbah_dihasilkan') is-invalid @enderror" value="{{ old('vol_limbah_dihasilkan', $pengaliran->vol_limbah_dihasilkan) }}" min="0" required>
                                <span class="input-group-text">m&sup3;</span>
                            </div>
                            @error('vol_limbah_dihasilkan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Vol. Dialirkan <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="number" name="vol_limbah_dialirkan" class="form-control @error('vol_limbah_dialirkan') is-invalid @enderror" value="{{ old('vol_limbah_dialirkan', $pengaliran->vol_limbah_dialirkan) }}" min="0" required>
                                <span class="input-group-text">m&sup3;</span>
                            </div>
                            @error('vol_limbah_dialirkan') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-3">
                            <label class="form-label fw-semibold">Luas Area <span class="text-danger">*</span></label>
                            <div class="input-group">
                                <input type="number" name="luas_area" class="form-control @error('luas_area') is-invalid @enderror" value="{{ old('luas_area', $pengaliran->luas_area) }}" step="0.1" min="0" required>
        ...
        <div class="col-lg-4">
            <div class="card form-card shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <select name="id_pks" class="form-control @error('id_pks') is-invalid @enderror" data-select2-selector="status" required>
                        ...
                        <option value="{{ $pks->ID }}" {{ old('id_pks', $pengaliran->id_pks) == $pks->ID ? 'selected' : '' }}>
                            {{ $pks->NAMA }} ({{ $pks->AKRO }})
                        </option>
                        @endforeach
                    </select>
            ...
            <div class="card form-card shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <textarea name="keterangan" rows="4" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Tambahkan catatan...">{{ old('keterangan', $pengaliran->keterangan) }}</textarea>
            ...
            <div class="card form-card shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    @if($pengaliran->foto)
                    <div class="mb-3">
                        <img src="{{ asset('gallery/' . $pengaliran->foto) }}" alt="Foto" class="current-photo">
