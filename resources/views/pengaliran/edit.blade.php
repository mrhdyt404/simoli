...
<form action="{{ route('pengaliran.update', $pengaliran->id_pengaliran) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="form-card">
                <div class="form-section-title"><i class="feather-clock"></i> Unit PKS &amp; Waktu Operasional</div>
                <div class="row g-3">
                    @if($user->isAdmin())
                    <div class="col-12">
                        <label class="form-label">Unit PKS <span class="text-danger">*</span></label>
                        <select name="id_pks" id="pks_selector" class="form-control @error('id_pks') is-invalid @enderror" data-select2-selector="status" required>
            ...
            <div class="form-card">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="vol_limbah_dialirkan" id="vol_dialirkan_input" style="color:#059669;"
...
<script>
    ...
    function checkVolumeDetection() {
        ...
        // KASUS 4: NORMAL
            ...
            desc.innerHTML = `Volume dialirkan (<strong>${volDialirkan.toLocaleString()} m³</strong>) seimbang dengan volume dihasilkan (<strong>${volDihasilkan.toLocaleString()} m³</strong>) dan dalam batas baku mutu teknis${debitIzin ? ' (' + debitIzin.toLocaleString() + ' m³/hari)' : ''}.`;
