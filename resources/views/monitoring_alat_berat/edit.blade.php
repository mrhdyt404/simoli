            ...
            <div class="col-lg-9 col-12">
                <div class="card stretch stretch-full">
                    <div class="card-header">
                        <h5 class="card-title">Edit Log Operasional Alat Berat</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('monitoring-alat-berat.update', $log->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="flat_bed" min="0" class="form-control @error('flat_bed') is-invalid @enderror" value="{{ old('flat_bed', $log->flat_bed ?? 0) }}">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="long_bed" min="0" class="form-control @error('long_bed') is-invalid @enderror" value="{{ old('long_bed', $log->long_bed ?? 0) }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" placeholder="-0.12345678" value="{{ old('latitude', $log->latitude) }}">
                                    @error('latitude') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Longitude (Garis Bujur)</label>
                                    <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" placeholder="101.12345678" value="{{ old('longitude', $log->longitude) }}">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="hm_awal" id="hm_awal" class="form-control @if($log->hm_awal || $log->foto_sebelum) bg-light @endif @error('hm_awal') is-invalid @enderror" placeholder="08:00 (Otomatis dari Foto Sebelum)" value="{{ old('hm_awal', $log->hm_awal_formatted) }}" @if($log->hm_awal || $log->foto_sebelum) readonly @endif>
                                    @if($log->hm_awal || $log->foto_sebelum)
                                        <small class="text-danger fs-11"><i class="feather-lock me-1"></i>HM Awal terkunci (terisi dari foto sebelum/data awal) untuk mencegah rekayasa.</small>
                                    @else
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" name="hm_akhir" id="hm_akhir" class="form-control @if($log->hm_akhir || $log->foto_sesudah) bg-light @endif @error('hm_akhir') is-invalid @enderror" placeholder="16:30 (Otomatis dari Foto Sesudah)" value="{{ old('hm_akhir', $log->hm_akhir_formatted) }}" @if($log->hm_akhir || $log->foto_sesudah) readonly @endif>
                                    @if($log->hm_akhir || $log->foto_sesudah)
                                        <small class="text-danger fs-11"><i class="feather-lock me-1"></i>HM Akhir terkunci (terisi dari foto sesudah/data akhir) untuk mencegah rekayasa.</small>
                                    @else
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" id="total_hm_display" class="form-control bg-light fw-bold text-primary" value="{{ $log->total_hm_formatted }} Jam" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    @if($log->foto_sebelum)
                                        <div class="mt-2">
                                            <small class="text-muted d-block mb-1">Foto sebelum kerja saat ini:</small>
                                            <img src="{{ asset('gallery/' . $log->foto_sebelum) }}" alt="Foto Sebelum Kerja" class="img-thumbnail" style="max-height: 120px;">
                                        </div>
                                    @endif
                                </div>
