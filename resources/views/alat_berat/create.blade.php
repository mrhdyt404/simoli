            ...
            <div class="col-lg-8 col-12">
                <div class="card stretch stretch-full">
                    <div class="card-header">
                        <h5 class="card-title">Form Master Alat Berat</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('alat-berat.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="text-muted">Kode unik identifikasi alat berat</small>
                            ...
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-primary"><i class="feather-save me-2"></i>Simpan Data</button>
                            </div>
                        </form>
                    </div>
                </div>
