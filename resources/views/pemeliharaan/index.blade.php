        ...
        <div class="col-xxl-2 col-md-4 col-6">
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <div class="pe-2">
                            <span class="stat-title">Total Flat Bed</span>
        ...
        <div class="col-xxl-2 col-md-4 col-6">
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <div class="pe-2">
                            <span class="stat-title">Total Long Bed</span>
        ...
        <div class="col-xxl-2 col-md-4 col-6">
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <div class="pe-2">
                            <span class="stat-title">Total HK</span>
        ...
        <div class="col-xxl-2 col-md-4 col-6">
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <div class="pe-2">
                            <span class="stat-title">Mekanis</span>
        ...
        <div class="col-xxl-2 col-md-4 col-6">
            <div class="card stat-card shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between mb-2">
                        <div class="pe-2">
                            <span class="stat-title">Manual</span>
