...
@section('title', 'Edit Data Pemeliharaan')
@section('page-title', 'Edit Data Pemeliharaan')
@section('page-description', 'Perbarui data pemeliharaan kolam & bed Land Aplikasi')
...
<style>
    /* ================================================================
       PEMELIHARAAN EDIT FORM — PTPN GREEN THEME
       ================================================================ */
...
<div class="edit-warning">
    ...
    <span>Anda sedang mengedit data pemeliharaan. Perubahan akan langsung tersimpan saat menekan <strong>"Perbarui"</strong>.</span>
</div>
            ...
            <div class="form-card">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $pemeliharaan->tanggal ? $pemeliharaan->tanggal->format('Y-m-d') : '') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="jenis_pemeliharaan" class="form-select @error('jenis_pemeliharaan') is-invalid @enderror">
                            ...
                            <option value="1" {{ old('jenis_pemeliharaan', $pemeliharaan->jenis_pemeliharaan) == '1' ? 'selected' : '' }}>Mekanis</option>
                            <option value="2" {{ old('jenis_pemeliharaan', $pemeliharaan->jenis_pemeliharaan) == '2' ? 'selected' : '' }}>Manual</option>
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            <input type="text" name="jumlah_hk" class="form-control @error('jumlah_hk') is-invalid @enderror" value="{{ old('jumlah_hk', $pemeliharaan->jumlah_hk) }}" placeholder="Contoh: 2" required>
            ...
            <div class="form-card">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="no_bak" class="form-control @error('no_bak') is-invalid @enderror" value="{{ old('no_bak', $pemeliharaan->no_bak) }}" placeholder="Contoh: 10" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="blok" class="form-control @error('blok') is-invalid @enderror" value="{{ old('blok', $pemeliharaan->blok) }}" placeholder="Contoh: 22L" required>
            ...
            <div class="form-card">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="flat_bed" class="form-control @error('flat_bed') is-invalid @enderror" value="{{ old('flat_bed', $pemeliharaan->flat_bed) }}" min="0" step="any" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="long_bed" class="form-control @error('long_bed') is-invalid @enderror" value="{{ old('long_bed', $pemeliharaan->long_bed) }}" min="0" step="any" required>
            ...
            <div class="form-card">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        @if($pemeliharaan->sebelum)
                        <div class="text-center mb-2">
                            <img src="{{ asset('gallery/' . $pemeliharaan->sebelum) }}" alt="Foto Sebelum Saat Ini" class="current-photo-img">
                        ...
                        <div class="photo-upload-box" onclick="document.getElementById('foto_sebelum').click()">
                            ...
                            <small class="text-muted d-block" id="label_sebelum">{{ $pemeliharaan->sebelum ? 'Upload baru untuk mengganti' : 'Klik untuk upload foto sebelum' }}</small>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($pemeliharaan->sesudah)
                        <div class="text-center mb-2">
                            <img src="{{ asset('gallery/' . $pemeliharaan->sesudah) }}" alt="Foto Sesudah Saat Ini" class="current-photo-img">
                            <small class="d-block text-muted">Foto saat ini</small>
                        </div>
                        @endif
                        <div class="photo-upload-box" onclick="document.getElementById('foto_sesudah').click()">
                            <i class="feather-upload-cloud d-block mb-2" style="font-size: 28px; color: #16a34a;"></i>
                            <small class="text-muted d-block" id="label_sesudah">{{ $pemeliharaan->sesudah ? 'Upload baru untuk mengganti' : 'Klik untuk upload foto sesudah' }}</small>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-card">
                ...
                <select name="id_pks" class="form-control @error('id_pks') is-invalid @enderror" data-select2-selector="status" required>
                    ...
                    <option value="{{ $pks->id_pks }}" {{ old('id_pks', $pemeliharaan->id_pks) == $pks->id_pks ? 'selected' : '' }}>
                        {{ $pks->nama }} ({{ $pks->akro }})
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-card">
                ...
                <textarea name="keterangan" rows="5" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Tambahkan catatan pemeliharaan...">{{ old('keterangan', $pemeliharaan->keterangan) }}</textarea>
