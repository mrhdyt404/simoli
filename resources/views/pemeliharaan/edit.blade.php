                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="mb-2 text-center">
                                <img src="{{ asset('gallery/' . $pemeliharaan->sebelum) }}" alt="Foto Sebelum" class="current-photo">
                            ...
                            <div class="photo-upload-area" onclick="document.getElementById('foto_sebelum').click()">
                                ...
                                <small class="text-muted">{{ $pemeliharaan->sebelum ? 'Upload foto baru untuk mengganti' : 'Klik untuk upload foto sebelum' }}</small>
                            ...
                            <img id="preview_sebelum" class="photo-preview" style="display:none;" alt="Preview Sebelum">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-2 text-center">
                                <img src="{{ asset('gallery/' . $pemeliharaan->sesudah) }}" alt="Foto Sesudah" class="current-photo">
                                <small class="d-block text-muted">Foto saat ini</small>
                            </div>
                            @endif
                            <div class="photo-upload-area" onclick="document.getElementById('foto_sesudah').click()">
                                <i class="feather-upload-cloud d-block text-muted mb-2" style="font-size: 28px;"></i>
                                <small class="text-muted">{{ $pemeliharaan->sesudah ? 'Upload foto baru untuk mengganti' : 'Klik untuk upload foto sesudah' }}</small>
                            ...
                            <img id="preview_sesudah" class="photo-preview" style="display:none;" alt="Preview Sesudah">
