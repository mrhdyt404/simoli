        ...
        <div class="navbar-wrapper">
            ...
            <div class="navbar-content">
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu {{ request()->is('report-pengaliran*') || request()->is('report-pemeliharaan*') || request()->is('report-rencana*') ? 'active' : '' }}">
                    ...
                    <li class="nxl-item nxl-hasmenu {{ request()->is('pengguna*') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="nxl-link">
                    ...
                    @else
                    {{-- Input Data (Unit) --}}
                    <li class="nxl-item nxl-hasmenu {{ request()->is('pengaliran*') || request()->is('pemeliharaan*') || request()->is('rencana*') ? 'active' : '' }}">
                        <a href="javascript:void(0);" class="nxl-link">
