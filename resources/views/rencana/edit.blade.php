...
@section('page-description', 'Perbarui Target Tahunan Rencana Flat Bed & Long Bed')
...
<style>
    /* ================================================================
       RENCANA EDIT FORM — PTPN GREEN THEME
       ================================================================ */
...
<div class="edit-warning">
    ...
    <span>Anda sedang mengedit data rencana target. Perubahan akan langsung tersimpan saat menekan <strong>"Perbarui Rencana"</strong>.</span>
</div>
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="bed-info">
                            ...
                            <input type="number" name="flat_bed" class="form-control form-control-lg @error('flat_bed') is-invalid @enderror" value="{{ old('flat_bed', $rencana->flat_bed) }}" min="0" step="any" style="color:#1d4ed8;font-weight:800;" required>
                    ...
                    <div class="col-md-6">
                        <div class="bed-info long">
                            ...
                            <input type="number" name="long_bed" class="form-control form-control-lg @error('long_bed') is-invalid @enderror" value="{{ old('long_bed', $rencana->long_bed) }}" min="0" step="any" style="color:#b45309;font-weight:800;" required>
        ...
        <div class="col-lg-4">
            ...
            <div class="form-card">
                ...
                <select name="id_pks" class="form-control @error('id_pks') is-invalid @enderror" data-select2-selector="status" required>
                    ...
                    <option value="{{ $pks->id_pks }}" {{ old('id_pks', $rencana->id_pks) == $pks->id_pks ? 'selected' : '' }}>
                        {{ $pks->nama }} ({{ $pks->akro }})
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-card">
                <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <h6 class="mb-0 fw-bold" style="font-family:'Outfit',sans-serif;color:#14532d;">Data Rencana Saat Ini</h6>
                        <small style="color:#6b7280;font-size:11.5px;">Record #{{ $rencana->id }}</small>
                    </div>
                </div>
                <div class="d-flex justify-content-between py-2 border-bottom">
                    ...
                    <span class="pks-badge" style="display:inline-flex;align-items:center;padding:2px 8px;border-radius:6px;font-size:10.5px;font-weight:800;background:linear-gradient(135deg,#052e16,#166534);color:#86efac;">
                        {{ $rencana->pks->AKRO ?? 'N/A' }}
                    </span>
                </div>
                <div class="d-flex justify-content-between py-2 border-bottom">
                    <span style="color:#6b7280;font-size:12.5px;">Tahun</span>
                    <span style="font-weight:800;font-size:13px;color:#14532d;">{{ $rencana->tahun }}</span>
                </div>
                <div class="d-flex justify-content-between py-2 border-bottom">
                    <span style="color:#6b7280;font-size:12.5px;">Flat Bed Target</span>
                    <span style="font-weight:800;font-size:13px;color:#1d4ed8;">{{ number_format($rencana->flat_bed) }}</span>
                </div>
                <div class="d-flex justify-content-between pt-2">
                    <span style="color:#6b7280;font-size:12.5px;">Long Bed Target</span>
                    <span style="font-weight:800;font-size:13px;color:#b45309;">{{ number_format($rencana->long_bed) }}</span>
                </div>
            </div>
