                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="bed-info">
                                ...
                                <input type="number" name="flat_bed" class="form-control form-control-lg @error('flat_bed') is-invalid @enderror" value="{{ old('flat_bed', 0) }}" min="0" step="any" required>
                        ...
                        <div class="col-md-6">
                            <div class="bed-info long">
                                ...
                                <input type="number" name="long_bed" class="form-control form-control-lg @error('long_bed') is-invalid @enderror" value="{{ old('long_bed', 0) }}" min="0" step="any" required>
        ...
        <div class="col-lg-4">
            ...
            <div class="card form-card shadow-sm mb-4">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <div class="stat-icon bg-soft-primary text-primary" style="width:44px;height:44px;border-radius:10px;display:flex;align-items:center;justify-content:center;">
                            <i class="feather-info" style="font-size:18px;"></i>
                        </div>
                        <div>
                            <h6 class="mb-0 fw-bold">Petunjuk</h6>
                            <small class="text-muted">Panduan pengisian</small>
                        </div>
                    </div>
                    <ul class="list-unstyled mb-0 fs-13">
                        <li class="mb-2">
                            <i class="feather-check-circle text-success me-2" style="font-size:13px;"></i>
                            Pilih unit PKS yang akan direncanakan
                        </li>
                        <li class="mb-2">
                            <i class="feather-check-circle text-success me-2" style="font-size:13px;"></i>
                            Tentukan tahun periode rencana
                        </li>
                        <li class="mb-2">
                            <i class="feather-check-circle text-success me-2" style="font-size:13px;"></i>
                            Masukkan target flat bed & long bed
                        </li>
                        <li>
                            <i class="feather-check-circle text-success me-2" style="font-size:13px;"></i>
                            Isi 0 jika tidak ada target bed
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="feather-save me-2"></i> Simpan Rencana
                </button>
